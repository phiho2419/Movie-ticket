            ...
            <div className="footer__content">
                <div className="row">
                    ...
                    <div className="col-12 d-none d-lg-block col-lg-3">
                        ...
                        <ul>
                            <li className="logoL">
                                <a href="https://www.cgv.vn/" className="logo"><img src={logoCgv} /></a>
                                <a href="https://www.galaxycine.vn/" className="logo"><img src={logoGalaxy} /></a>
                                <a href="http://lottecinemavn.com/LCHS/index.aspx"><img src={logoLotte} /></a>

                            </li>
                            <li className="logoL">
                                <a href="https://www.bhdstar.vn/" className="logo"><img src={logoBhd} /></a>
                                <a href="https://www.megagscinemas.vn/" className="logo"><img src={logoMegags} /></a>
                                <a href="http://ddcinema.vn/"><img src={logoDongda} /></a>

                            </li>
                            <li>
                                <a href="http://cinestar.com.vn/" className="logo"><img src={logoCinestar} /></a>
                                <a href="https://cinemaxvn.com/" className="logo"><img src={logoCnx} /></a>
                                <a href="https://www.betacinemas.vn/home.htm"><img src={logoBt} /></a>
